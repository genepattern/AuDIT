...
docker run --rm -v $PWD:$PWD -w $PWD genepattern/audit:0.3 /build/audit/run_audit.sh $PWD/gpunit/skyline_export/skyline-export-data.xls results .00001 0.2 FALSE TRUE FALSE
